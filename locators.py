...
class MainPageLocators:
    ...
    sql_banner = (By.CSS_SELECTOR, 'div.container ul li:first-child div')
    python_banner = (By.CSS_SELECTOR, 'div.container ul li:nth-child(2) div')
    java_script_banner = (By.CSS_SELECTOR, 'div.container ul li:nth-child(3) div')
